...
\vspace*{-0.3cm}
\item
\open, command line, git, github, bitbucket, \LaTeX, software building
tools, OpenStreetMap.
\vspace*{-0.3cm}
\item
\teachingknow, \gis, Arc\sigla{GIS}, \hci, \is, \cg.
\vspace*{-0.3cm}
\item
\textbf{Beginner} in JavaScript, JQuery, Python, Django.
\end{itemize}
