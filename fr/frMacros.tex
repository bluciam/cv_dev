...
J'ai +10 d'années d'expérience en \sigla{TI} et plus d'un an en
développement Web.  Je voudrais utiliser mes compétences en conception,
documentation, formation, leadership et communication dans la réalisation
de logiciels et la résolution de problèmes dans une équipe de développement.
Je suis toujours en train d'apprendre et d'expérimenter avec des
technologies de pointe, de lire des blogues technologiques, de participer
aux MeetUps, ou en twitter.

\newcommand{\RoR}{\textsl{Ruby on Rails}}

}
\newcommand{\web}{\textbf{Programmation web}, {\RoR}, méthodes de
testing, \sigla{css} et Bootstrap, \sigla{html}}
\newcommand{\open}{Outils de développement «\textbf{open source}», Linux, langages de scripting}
\newcommand{\teachingknow}{\textbf{Connaissances} en \sigla{C}, %\sigla{C}++,
  \sigla{JSP}, Java, Haskell, Arc\sigla{GIS}}
\newcommand{\cli}{interface ligne de commande}
\newcommand{\swtools}{outils de contruction de logiciels}
...
%Descriptions
\newcommand{\webdevA}{De la création au déploiement du site web
d'un StartUp montréalais en \RoR\ (en cours). Seule personne technique}
\newcommand{\webdevB}{Conception et développement front-end en utilisant
\sigla{CSS} et \sigla{HTML}}
\newcommand{\writerDesc} 
  {Transformation de entrevues pour demandes de subvention}
...
\newcommand{\curriculum}{réviseur et éditeur de syllabus}
\newcommand{\specwriter}{rédacteur de spécifications}
...
travaux pratiques}
\newcommand{\softwarelab}{instructeur de laboratoire informatique}
\newcommand{\marker}{correcteur}
\newcommand{\sysAdmin}{Gérant du système informatique}
\newcommand{\tutor}{Enseignant-tuteur}
\newcommand{\researchAssistant}{Assistant de recherche}
...
\newcommand{\localChairDesc}{directeur de conférence et de budget}
...
\newcommand{\girlsWorkshops}{%
  \emph{Girls in Science and Technology Workshops} (une initiative d'Anita
  Borg)\\
  Organisateur pionnier, coordonnateur, chef d'équipe:
  ateliers en \sigla{html}, Lego Mindstorms et iMovie,
  discours de bienvenue, analyse rétrospective.
}
...
% TOOLS
\newcommand{\progLangs}{Langages de programmation (C, Java,
...
Le logiciel \texttt{S$^3$} fut créé afin de démontrer l'utilisation de
documents électroniques contextuels, dans le cas d'étude d'un tableur
...
itérations du développement devaient être flexibles et donner de l'espace aux
changements \mbox{continuels} d'exigences, d'outils et % d'inventions
de découvertes de recherche. Il fut un succès.
}

\newcommand{\translucid}{%
Dans l'équipe du projet, j'ai contribué à la conception et au planning
...
j'étais le testeur interactif principal.
}
