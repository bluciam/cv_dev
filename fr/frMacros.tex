...
Je voudrais utiliser mes compétences dans la réalisation des logiciels,
solution de problèmes, conception, documentation, formation, leadership et
communication dans une équipe de développement. 
Je suis toujours en train d'apprendre et  d'expérimenter
avec des technologies de pointe, de lire des blogues technologique, de
participer aux MeetUps, ou en twitter.
}
\newcommand{\web}{Programmation web avec Ruby on Rails, méthodes de
...
\newcommand{\nameWriter}{Rédactrice technique}
\newcommand{\facultymember}{Membre du corps professoral}
\newcommand{\assistant}{Assistante de laboratoire}
\newcommand{\supervisor}{Superviseur}
\newcommand{\consultant}{Consultante}
\newcommand{\webdev}{Dévélopeur web}

%Descriptions
\newcommand{\webdevA}{De l'inception au déploiement du site web en Ruby on
Rails d'un StartUp montréalais. Seule personne technique (en
cours)}
\newcommand{\webdevB}{Développeur front-end avec conception, en utilisant
...
%Descriptions
\newcommand{\assesortheses}{correctrice et conseillère}
...
%\newcommand{\docwriter}{rédactrice de documentation}
...
\newcommand{\girlsWorkshops}{%
  ...
  Ateliers sur \sigla{html}, Lego Mindstorms et iMovie, chef d'équipe.
}
...
multidimensionnel. Il couvre inception, conception, recherche et
développement.} 

\newcommand{\acms}{%
Le projet \texttt{ACMS} fut développé comme preuve de concept. Les
itérations du développement devait être flexibles et donner l'espace aux
